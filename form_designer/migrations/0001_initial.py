    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_template_name', models.CharField(blank=True, max_length=255, null=True, verbose_name='form template', choices=[(b'', 'Default'), (b'html/formdefinition/forms/as_p.html', 'as paragraphs'), (b'html/formdefinition/forms/as_p_cms.html', 'as paragraphs for cms'), (b'html/formdefinition/forms/as_table.html', 'as table'), (b'html/formdefinition/forms/as_table_h.html', 'as table (horizontal)'), (b'html/formdefinition/forms/as_ul.html', 'as unordered list'), (b'html/formdefinition/forms/custom.html', 'custom implementation')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('widget', models.CharField(default=b'', choices=[(b'', 'Default'), (b'django.forms.widgets.Textarea', 'Text area'), (b'django.forms.widgets.PasswordInput', 'Password input'), (b'django.forms.widgets.HiddenInput', 'Hidden input'), (b'django.forms.widgets.RadioSelect', 'Radio button'), (b'django.forms.widgets.CheckboxSelectMultiple', 'Checkbox')], max_length=255, blank=True, null=True, verbose_name='widget')),
